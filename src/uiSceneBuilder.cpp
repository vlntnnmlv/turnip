...
#include "feyerverx/uiSceneBuilder.hpp"
...
ecs::Entity UISceneBuilder::CreateImage(ecs::Entity _Parent, Texture &_Texture, LRTB _Patch,
                                        Color _Color, Size _Size, LRTB _Margin, LRTB _Padding) {
...
ecs::Entity UISceneBuilder::CreateText(ecs::Entity _Parent, const std::string &_Text, Font &_Font,
                                       float _FontSize, float _Spacing, Color _Color, Size _Size,
...
ecs::Entity UISceneBuilder::CreateLabeledButton(ecs::Entity _Parent, std::function<void()> _OnClick,
                                                Texture &_Texture, const std::string &_Text,
                                                Font &_Font, float _FontSize, float _Spacing,
                                                LRTB _Patch, Color _Color, Size _Size, LRTB _Margin,
                                                LRTB _Padding) {
    ecs::Entity node = CreateNode(_Parent, _Size, _Margin, _Padding);
    ecs::Entity img = CreateNode(node);
