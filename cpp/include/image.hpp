...
public:
  Image(const std::string &_ID, turnip::ImageInfo _ImageInfo,
  ...
  void Render() override {
    ...
    NPatchInfo patchInfo = NPatchInfo{
        Rectangle{0, 0, static_cast<float>(m_ImageInfo.texture.width),
    ...
    DrawTextureNPatch(m_ImageInfo.texture, patchInfo, WorldRect(), {0, 0}, 0,
                      Color());
  }
